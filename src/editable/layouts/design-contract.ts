...
export const editableRootStyle = {
  ...
  '--slot4-page-bg': '#05051f',
  '--slot4-page-text': '#f8f7ff',
  '--slot4-panel-bg': '#11103b',
  '--slot4-surface-bg': '#0b0a2d',
  '--slot4-muted-text': '#b8b3d4',
  '--slot4-soft-muted-text': '#8e88b0',
  '--slot4-accent': '#8b5cf6',
  '--slot4-accent-fill': '#5b21f4',
  '--slot4-accent-soft': '#20175c',
  '--slot4-on-accent': '#ffffff',
  '--slot4-dark-bg': '#020217',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#171542',
  '--slot4-cream': '#0b0a2d',
  '--slot4-warm': '#080727',
  '--slot4-lavender': '#151047',
  '--slot4-gray': '#0e0d34',
  '--slot4-body-gradient': 'radial-gradient(circle at 80% 0%, rgba(91,33,244,.18), transparent 34%)',
  '--editable-page-bg': '#05051f',
  '--editable-page-text': '#f8f7ff',
  '--editable-container': '1360px',
  '--editable-border': '#302a66',
  '--editable-nav-bg': '#05051f',
  '--editable-nav-text': '#f8f7ff',
  '--editable-nav-active': '#8b5cf6',
  '--editable-nav-active-text': '#ffffff',
  '--editable-cta-bg': '#5b21f4',
  '--editable-cta-text': '#ffffff',
  '--editable-search-bg': '#11103b',
  '--editable-footer-bg': '#020217',
  '--editable-footer-text': '#f8f7ff',
} as CSSProperties
